...
#%% Load data
species = pd.read_csv("results/species_RTEs.csv",index_col=0)
...
labels = labels = ["","Immune cells","Epithelial cells","Neurons","Respiratory tract","Hepatocytes","Intestine"]
...
#%% Save
principalDf.to_csv("results/DiscriminantAnalysis_species_SDAtissues.csv")
coef.to_csv("results/DiscriminantAnalysis_species_SDAtissues_features.csv")
