...
#%% Load data
species = pd.read_csv("results/virus_Xs_RCUs.csv",index_col=0)
...
labels = ["","Immune cells","Epithelial cells","Neurons","Respiratory tract","Hepatocytes","Intestine"]
...
#%% Save
principalDf.to_csv("results/DiscriminantAnalysis_Xs_tropism.csv")